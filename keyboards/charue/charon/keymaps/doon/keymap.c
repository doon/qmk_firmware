...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   [_BASE] = LAYOUT_65_ansi(
        ...
        KC_LCTL, KC_A   , KC_S   , KC_D   , KC_F   , KC_G   , KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT, KC_QUOT,   KC_ENT,           KC_VOLD,
        KC_LSFT,          KC_Z   , KC_X   , KC_C   , KC_V   , KC_B   , KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH,           KC_RSFT, KC_UP  , KC_MUTE,
        KC_LCTL, KC_LALT, KC_LGUI,                            LT(_FN,KC_SPC) ,                            KC_RALT,                    KC_LEFT, KC_DOWN, KC_RGHT),
